      ...
      <section className="bg-navy py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl space-y-6">
            <div className="inline-flex items-center space-x-2 text-gold font-bold uppercase tracking-widest text-sm">
              <Globe2 className="h-4 w-4" />
              <span>Global Sağlık Güvencesi</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-white">Sağlık Turizmi Komplikasyon Sigortası</h1>
            ...
            <Button size="lg" className="bg-gold text-navy font-bold rounded-none px-8">Hemen Online Poliçe Kes</Button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <h2 className="text-3xl md:text-4xl font-bold text-navy">Dijital Platformumuzla Saniyeler İçinde Güvence</h2>
            ...
            <div className="bg-navy p-12 text-white relative">
              ...
              <h3 className="text-2xl font-bold mb-8">Kimler İçin Uygundur?</h3>
              <ul className="space-y-6">
                <li className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-bold text-lg">Sağlık Kuruluşları</p>
                ...
                <li className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-bold text-lg">Aracı Kurumlar</p>
                ...
                <li className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-bold text-lg">Bireysel Hastalar</p>
