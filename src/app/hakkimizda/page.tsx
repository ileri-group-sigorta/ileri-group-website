        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            <div className="relative order-2 lg:order-1">
              <div className="aspect-[4/3] sm:aspect-[4/5] overflow-hidden border-4 sm:border-8 border-navy/5">
                <img 
            ...
            <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
              <div className="space-y-3 sm:space-y-4">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-navy">Tarihçemiz ve Misyonumuz</h2>
              ...
              <div className="p-4 sm:p-6 bg-navy/5 border-l-4 border-gold">
                <p className="text-navy font-medium italic text-sm sm:text-base">
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-10 sm:mb-12 md:mb-16 space-y-4 sm:space-y-6">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-navy">Vizyon ve Değerlerimiz</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <div className="bg-white p-6 sm:p-8 border-t-4 border-gold hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-navy mb-3 sm:mb-4">Güvenilirlik</h3>
            ...
            <div className="bg-white p-6 sm:p-8 border-t-4 border-gold hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-navy mb-3 sm:mb-4">Uzmanlık</h3>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            <div className="bg-white p-6 sm:p-8 border-t-4 border-gold hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-navy mb-3 sm:mb-4">Yenilikçilik</h3>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            <div className="bg-white p-6 sm:p-8 border-t-4 border-gold hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-navy mb-3 sm:mb-4">Müşteri Memnuniyeti</h3>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                Her şeyden önce müşteri memnuniyetini gözetiriz. Bizden aldığınız her hizmetin içinize sinmesi en büyük önceliğimizdir.
              </p>
            </div>

            <div className="bg-white p-6 sm:p-8 border-t-4 border-gold hover:shadow-lg transition-shadow sm:col-span-2">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-navy/5 flex items-center justify-center text-navy mb-4 sm:mb-6">
                <HandshakeIcon className="h-6 w-6 sm:h-7 sm:w-7" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-navy mb-3 sm:mb-4">Toplumsal Sorumluluk</h3>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12 md:mb-16 space-y-4 sm:space-y-6">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-navy">Referanslar ve Başarılarımız</h2>
            <div className="h-1 w-16 sm:w-20 bg-gold mx-auto" />
            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-10 sm:mb-12 md:mb-16">
            <div className="p-4 sm:p-6 bg-muted/30 text-center group hover:bg-gold/10 transition-colors">
              <Hospital className="h-8 w-8 sm:h-10 sm:w-10 text-navy mx-auto mb-3 sm:mb-4 group-hover:text-gold transition-colors" />
              <div className="text-xs sm:text-sm font-medium text-navy">Hastaneler & Klinikler</div>
            </div>
            <div className="p-4 sm:p-6 bg-muted/30 text-center group hover:bg-gold/10 transition-colors">
              <Building className="h-8 w-8 sm:h-10 sm:w-10 text-navy mx-auto mb-3 sm:mb-4 group-hover:text-gold transition-colors" />
              <div className="text-xs sm:text-sm font-medium text-navy">Sağlık Turizmi</div>
            </div>
            <div className="p-4 sm:p-6 bg-muted/30 text-center group hover:bg-gold/10 transition-colors">
              <Truck className="h-8 w-8 sm:h-10 sm:w-10 text-navy mx-auto mb-3 sm:mb-4 group-hover:text-gold transition-colors" />
              <div className="text-xs sm:text-sm font-medium text-navy">Lojistik Firmaları</div>
            </div>
            <div className="p-4 sm:p-6 bg-muted/30 text-center group hover:bg-gold/10 transition-colors">
              <Factory className="h-8 w-8 sm:h-10 sm:w-10 text-navy mx-auto mb-3 sm:mb-4 group-hover:text-gold transition-colors" />
              <div className="text-xs sm:text-sm font-medium text-navy">Üretim & İnşaat</div>
            </div>
          </div>
          ...
          <div className="mt-10 sm:mt-12 md:mt-16 p-4 sm:p-6 md:p-8 bg-muted/30 border-l-4 border-gold max-w-4xl mx-auto">
            <p className="text-base sm:text-lg text-navy leading-relaxed">
